...
complete -c pix -n "__fish_use_subcommand" -a "setup" -d "Run the interactive setup wizard"
...
complete -c pix -n "__fish_seen_subcommand_from help" -a "ls graph run shell setup upgrade cache completion_script" -d "Command"
