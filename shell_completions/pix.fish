...
complete -c pix -n "__fish_use_subcommand" -a "completion" -d "Generate shell completion script"
...
complete -c pix -n "__fish_seen_subcommand_from completion" -a "fish\t'Fish shell completion script'"
